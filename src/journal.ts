...
export const JOURNAL_INTAKE: Record<string, JournalColumnClass> = {
  ...
  // ------------------------------------------------------ 0017: THE OUTCOMES
  // What a skill DID, which is a different fact from what a runtime LOADED. The
  // reporter-supplied text here is declared-limit for the reason the receipt's
  // is: an outcome this registry could only accept in a vocabulary it shipped is
  // an outcome no real runtime can file.
  "session_closures.id": { intake: "registry_generated", note: "a ULID this registry mints" },
  "session_closures.session_id": { intake: "registry_generated", note: "a row of this registry" },
  "session_closures.workspace_id": { intake: "registry_generated", note: "copied from the session row" },
  "session_closures.closed_by_agent_id": { intake: "registry_generated", note: "taken from AuthContext" },
  "session_closures.source": { intake: "bounded_form", note: "backend|adapter|runtime — derived from the registration, never from the body" },
  "session_closures.reason_code": { intake: "bounded_form", note: "the registry's own SESSION_CLOSED" },
  "session_closures.reason": { intake: "declared_limit", note: "the closer's words, 1..2000, stored and never parsed for a decision" },
  "session_closures.entries_without_outcome": { intake: "registry_generated", note: "counted by the registry while it wrote them" },
  "session_closures.closed_at_ms": { intake: "registry_generated", note: "the registry clock" },
  "session_closures.server_at_ms": { intake: "registry_generated", note: "the registry clock" },

  "session_outcomes.id": { intake: "registry_generated", note: "a ULID this registry mints" },
  "session_outcomes.session_id": { intake: "registry_generated", note: "a row of this registry" },
  "session_outcomes.loadout_id": { intake: "registry_generated", note: "resolved from the session, never from the body" },
  "session_outcomes.loadout_entry_id": { intake: "registry_generated", note: "resolved from the loadout and the reported revision" },
  "session_outcomes.assignment_id": { intake: "registry_generated", note: "copied from the entry row" },
  "session_outcomes.draft_id": { intake: "registry_generated", note: "copied from the entry row" },
  "session_outcomes.draft_revision_id": { intake: "registry_generated", note: "copied from the entry row after the reported id matched it" },
  "session_outcomes.content_digest": { intake: "digest", note: "the entry's own digest, copied rather than recomputed — what the reported digest was checked against" },
  "session_outcomes.outcome": { intake: "bounded_form", note: "worked|failed|rolled_back|nothing_reported — the whole vocabulary, and a runtime may report only the first two" },
  "session_outcomes.evidence_class": { intake: "bounded_form", note: "runtime_receipt|owner_confirmation|session_closed|rollback_confirmation — derived from the route and the principal" },
  "session_outcomes.outcome_ref": { intake: "declared_limit", note: "the reporter's own identifier, 1..200 — the replay key, and the registry mints it itself for a closure or a rollback" },
  "session_outcomes.reason_code": { intake: "declared_limit", note: "an UPPER_SNAKE code the reporter chose, 1..64: a code list this registry shipped would be a code no real runtime can use" },
  "session_outcomes.reason": { intake: "declared_limit", note: "the reporter's words, 1..2000, stored and never parsed for a decision" },
  "session_outcomes.source": { intake: "bounded_form", note: "backend|adapter|runtime|owner — derived, and `owner` only ever with evidence_class owner_confirmation" },
  "session_outcomes.confirmation_source": { intake: "declared_limit", note: "where the OWNER saw it, 1..200, required of an owner confirmation and null otherwise" },
  "session_outcomes.runtime_session_ref": { intake: "declared_limit", note: "the runtime's own session identifier, 1..200 — a vocabulary this registry shipped would be one no real runtime can use" },
  "session_outcomes.invocation_ref": { intake: "declared_limit", note: "the runtime's own invocation identifier, 1..200 — matched against the `invoked` receipt rather than interpreted" },
  "session_outcomes.invocation_receipt_id": { intake: "registry_generated", note: "the id of the `invoked` receipt this outcome was matched to — resolved here, never supplied" },
  "session_outcomes.rollback_to_revision_id": { intake: "registry_generated", note: "read from the rollback event, not from the body" },
  "session_outcomes.rollback_action_event_id": { intake: "registry_generated", note: "the lifecycle event this outcome records, checked to be a revision selection of this assignment" },
  "session_outcomes.reported_by_agent_id": { intake: "registry_generated", note: "taken from AuthContext" },
  "session_outcomes.outcome_digest": { intake: "digest", note: "over the canonical payload — what a redelivery is compared against" },
  "session_outcomes.payload_json": { intake: "registry_generated", note: "assembled by the registry from checked values; the reporter's text enters it through the columns above" },
  "session_outcomes.observed_at_ms": { intake: "declared_limit", note: "the REPORTER's clock, kept as reported; `server_at_ms` beside it is this registry's" },
  "session_outcomes.server_at_ms": { intake: "registry_generated", note: "the registry clock" },

  "outcome_conflicts.id": { intake: "registry_generated", note: "a ULID this registry mints" },
  "outcome_conflicts.session_id": { intake: "registry_generated", note: "a row of this registry" },
  "outcome_conflicts.loadout_entry_id": { intake: "registry_generated", note: "resolved from the loadout" },
  "outcome_conflicts.outcome_ref": { intake: "declared_limit", note: "the key the second delivery arrived under, 1..200 — the reporter's own identifier and not one this registry could enumerate" },
  "outcome_conflicts.existing_outcome_id": { intake: "registry_generated", note: "the row that STANDS — this table never overwrites it" },
  "outcome_conflicts.existing_outcome": { intake: "registry_generated", note: "copied from that row" },
  "outcome_conflicts.claimed_outcome": { intake: "bounded_form", note: "worked|failed|rolled_back|nothing_reported — what the contradicting delivery claimed" },
  "outcome_conflicts.claimed_payload_json": { intake: "registry_generated", note: "the whole of the claim, assembled by the registry from checked values" },
  "outcome_conflicts.conflict_digest": { intake: "digest", note: "over the two digests and the key, so one conflict is one identity" },
  "outcome_conflicts.reported_by_agent_id": { intake: "registry_generated", note: "taken from AuthContext" },
  "outcome_conflicts.source": { intake: "bounded_form", note: "backend|adapter|runtime|owner — derived from the principal" },
  "outcome_conflicts.observed_at_ms": { intake: "declared_limit", note: "the REPORTER's clock at the moment of the contradicting delivery, kept as reported; `server_at_ms` beside it is this registry's" },
  "outcome_conflicts.server_at_ms": { intake: "registry_generated", note: "the registry clock" },

  "revision_sources.id": { intake: "registry_generated", note: "a ULID this registry mints" },
  "revision_sources.draft_id": { intake: "registry_generated", note: "read from the outcome the revision was created from" },
  "revision_sources.draft_revision_id": { intake: "registry_generated", note: "the revision the compiler just produced" },
  "revision_sources.parent_revision_id": { intake: "registry_generated", note: "read from the source outcome, never from the body" },
  "revision_sources.origin": { intake: "bounded_form", note: "failure|feedback" },
  "revision_sources.source_outcome_id": { intake: "registry_generated", note: "the outcome named in the path, loaded and checked" },
  "revision_sources.source_session_id": { intake: "registry_generated", note: "read from that outcome" },
  "revision_sources.source_receipt_id": { intake: "registry_generated", note: "the invocation receipt behind that outcome, read from it" },
  "revision_sources.observation": { intake: "declared_limit", note: "the owner's words, 1..2000 — what was wrong or was remarked on" },
  "revision_sources.improvement_goal": { intake: "declared_limit", note: "the owner's words, 1..2000, recorded BEFORE the new revision runs anywhere" },
  "revision_sources.goal_kind": { intake: "bounded_form", note: "failure_to_worked|declared_binary" },
  "revision_sources.created_by_agent_id": { intake: "registry_generated", note: "taken from AuthContext" },
  "revision_sources.created_at_ms": { intake: "registry_generated", note: "the registry clock" },
  "revision_sources.server_at_ms": { intake: "registry_generated", note: "the registry clock" },

  "revision_comparisons.id": { intake: "registry_generated", note: "a ULID this registry mints" },
  "revision_comparisons.workspace_id": { intake: "registry_generated", note: "taken from AuthContext" },
  "revision_comparisons.draft_id": { intake: "registry_generated", note: "read from the candidate outcome" },
  "revision_comparisons.revision_source_id": { intake: "registry_generated", note: "the lineage row of the candidate revision" },
  "revision_comparisons.baseline_revision_id": { intake: "registry_generated", note: "read from the baseline outcome" },
  "revision_comparisons.candidate_revision_id": { intake: "registry_generated", note: "read from the candidate outcome" },
  "revision_comparisons.baseline_outcome_id": { intake: "registry_generated", note: "the outcome named in the body, loaded and checked" },
  "revision_comparisons.candidate_outcome_id": { intake: "registry_generated", note: "the outcome named in the body, loaded and checked" },
  "revision_comparisons.baseline_outcome": { intake: "registry_generated", note: "copied from that row" },
  "revision_comparisons.candidate_outcome": { intake: "registry_generated", note: "copied from that row" },
  "revision_comparisons.comparable": { intake: "registry_generated", note: "computed from the two sessions and the lineage" },
  "revision_comparisons.scenario_json": { intake: "registry_generated", note: "the three comparisons that decided it, assembled by the registry" },
  "revision_comparisons.improvement_goal": { intake: "registry_generated", note: "copied from the lineage row, so a comparison cannot restate the goal" },
  "revision_comparisons.goal_kind": { intake: "registry_generated", note: "copied from the lineage row" },
  "revision_comparisons.verdict": { intake: "bounded_form", note: "improved|not_improved|not_comparable — COMPUTED, never supplied by a caller" },
  "revision_comparisons.verdict_reason_code": { intake: "registry_generated", note: "the registry's own code for the condition that decided it" },
  "revision_comparisons.verdict_reason": { intake: "registry_generated", note: "the registry's own words" },
  "revision_comparisons.created_by_agent_id": { intake: "registry_generated", note: "taken from AuthContext" },
  "revision_comparisons.created_at_ms": { intake: "registry_generated", note: "the registry clock" },
  "revision_comparisons.server_at_ms": { intake: "registry_generated", note: "the registry clock" },
...
export const JOURNAL_WRITERS: Record<string, readonly string[]> = {
  ...
  session_closures: ["src/outcome-loop.ts"],
  session_outcomes: ["src/outcome-loop.ts"],
  outcome_conflicts: ["src/outcome-loop.ts"],
  revision_sources: ["src/outcome-loop.ts"],
  revision_comparisons: ["src/outcome-loop.ts"],
