...
const MIGRATION_BLOCKS: ReadonlyArray<{ heading: string; file: string }> = [
  ...
  { heading: "### D.1k NORMATIVE DELTA", file: "migrations/0011_the_key_of_a_repeat_is_a_digest_on_every_row.sql" },
];
...
test("§2, the help text, README and OPERATIONS list the same subcommands", () => {
  ...
  assert.deepEqual(subcommands.sort(), ["help", "serve", "verify", "verify-log", "version"]);
