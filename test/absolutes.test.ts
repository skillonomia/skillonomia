...
const DECLARED: ReadonlyArray<Declared> = ([] as Row[]).concat(
  ...
  [
    ...
    ["SECURITY.md", "6838cbac7cadc5df", "intent", "the supported-versions row for the version this tree declares, restating that policy"],
...
test("the true form of each planted family passes", () => {
  ...
  const TRUE_FORMS = [
    ...
    "The normative schema is given in **seventeen** migrations, applied in ascending order.",
