...
const DECLARED: ReadonlyArray<Declared> = ([] as Row[]).concat(
  ...
  [
    ...
    ["SECURITY.md", "b4ceb998b1a41cc0", "intent", "no patch SLA at this version; a maintenance policy"],
    ["SECURITY.md", "b6df1ab62defd342", "intent", "no security maintenance commitment; a maintenance policy"],
