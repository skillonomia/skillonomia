...
//
//   node ci/mvp-release.mjs binary --tag v0.1.5         # the release path: download, then smoke
...
//   node ci/mvp-release.mjs preflight --tag v0.1.5      # BEFORE the tag: can this release happen at all
//
...
//
//   node ci/mvp-release.mjs preflight --tag v0.1.5 --repo skillonomia/skillonomia
//
